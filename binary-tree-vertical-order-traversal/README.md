<h2>  Binary Tree Vertical Order Traversal</h2><hr><div bis_skin_checked="1"><p>Given the <code>root</code> of a binary tree, return <em><strong>the vertical order traversal</strong> of its nodes' values</em>. (i.e., from top to bottom, column by column).</p>
