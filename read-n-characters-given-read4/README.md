<h2>  Read N Characters Given Read4</h2><hr><div bis_skin_checked="1"><p>Given a <code>file</code> and assume that you can only read the file using a given method <code>read4</code>, implement a method to read <code>n</code> characters.</p>
